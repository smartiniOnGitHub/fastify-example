...
* [x] general: check if restructure the whole project to become a monorepo (with multiple interdependent packages inside it, for example using [lerna - npmjs](https://www.npmjs.com/package/lerna), like: server, common, client, docs, etc ... wip
